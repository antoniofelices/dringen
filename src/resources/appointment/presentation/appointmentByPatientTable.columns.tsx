...
import { contentES as content } from './appointmentByPatientTable.content'

const appointmentByPatientTableColumns = (
...
export default appointmentByPatientTableColumns
