...
import { createMockClinicalHistory, createMockUsePatientContextReturn } from '../testTypes'
...
describe('usePatientMetrics', () => {
    ...
    describe('useDataWeight', () => {
        it('should return weight data for nutritional consultations only', async () => {
            const { usePatientContext } = await import('@/hooks/usePatientContext')
            vi.mocked(usePatientContext).mockReturnValue(createMockUsePatientContextReturn({
